...
public class FindReviews extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request,
        ...
        String retailerZipcode = request.getParameter("retailerpin");
        String retailerCity = null;
        System.out.println("productname"+productName);

        System.out.println("productRating"+reviewRating);
        System.out.println("compareRating"+compareRating);
        System.out.println("comparePrice"+comparePrice);
        System.out.println("retailerzipcode"+retailerZipcode);
        ...
        if (filters != null && groupBy != true) {
            for (int i = 0; i < filters.length; i++) {
                ...
                System.out.println(query+"llllllllllllllllllllllllllllllllllllllllllllllllllllllllll");
            }
        } else {
            //Show all the reviews if nothing is selected
            noFilter = true;
        ...
        if (groupBy == true) {
            ...
            if (groupByCity) {
                ...
                projectFields.put("ReviewValue", "$count");
                projectFields.put("Product", "$productName");
                projectFields.put("Rating", "$reviewRating");
        ...
        pw.print("<div id='content' style='background-color: white; display: flex; justify-content: center; padding-bottom: 20px;'><div class='post'><h2 class='title meta'>");
        pw.print("<a style='font-size: 24px;'>Data Analytics on Review</a>");
        pw.print("</h2><div class='entry' style='border:1px;'>");
        if (groupBy == true) {
    ...
    public void constructGroupByContent(AggregationOutput aggregate, PrintWriter pw, String dataGroupBy) {
        ...
        if (dataGroupBy.equals("Count")) {
            ...
            for (DBObject result : aggregate.results()) {
                ...
                tableData = "<tr><td> " + bobj.getString("value") + "</td>&nbsp"
                        + "<td>" + bobj.getString("ReviewValue") + "</td></tr><tr><td><br><br></td></tr>";
                pw.print(tableData);
                count++;
            }
        }
        ...
        if (dataGroupBy.equals("Detail")) {
                    System.out.println("inside 1 inside 2" );
 ...
 System.out.println("inside 1 inside 2"+ productList+"lllllllllllllll"+rating+"lllllkkkkkk"+zipcode);
                ...
                while (detailcount < productList.size()) {
                    ...
                    tableData = "<tr rowspan = \"3\"><td> Product: " + productList.get(detailcount)  + "</br>"
                            ...
                            + "retailerzipcode: " + zipcode.get(detailcount) + "</td></tr><tr><td><br><br></td></tr>";
    ...
    public void constructTableContent(DBCursor dbCursor, PrintWriter pw) {
        ...
        while (dbCursor.hasNext()) {
            ...
            tableData = "<tr><td align='center' colspan='2'>Review</td></tr><tr><td>Name: </td><td>" + bobj.getString("productName") + "</td></tr>"
                    ...
                    + "<tr><td>RetailerZipCode:</td><td>" + bobj.getString("retailerpin") + "</td><tr><tr><td><br><br></td></tr>";

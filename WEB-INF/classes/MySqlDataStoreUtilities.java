...
public class MySqlDataStoreUtilities {
    ...
    public static void getConnection() {
        ...
        try {
            ...
            conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/project?useUnicode=true&characterEncoding=utf8", "root", "f8lw2A9sp");
        } catch (Exception e) {
...
{   
    ...
    try 
    {
        ...
        String selectFood="select * from grocery_food";

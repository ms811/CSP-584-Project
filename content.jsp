      ...
      <div class="col-lg-3" >
        <div class="col-sm">
          <div class="panel panel-primary" id="leftnavbar">
            ...
            <div class="panel-body" style="height: 50%;"><a href="${pageContext.request.contextPath}/Foodslist"><img src="./images/foo.jpg" class="rounded" style="height:50%;width:100%;" alt="Food Image"></div>
        ...
        <div class="col-lg-8" id="maincontent">
          <img src="./images/main.png" class="img-responsive" style="width:100%; margin-bottom: 20px;" alt="Main image in the landing page">
        </div>
        <hr>
        <div class="col-lg-8" id="maincontent">
          <h3>Best Deals</h3>
...
>>>>>>> d7f3e9bd1e1dd4cb40d8afb0e6a3d04810b9a198

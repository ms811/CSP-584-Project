  ...
  <div class="row">
    ...
    <div class="col-sm-4"> 
      <div class="panel panel-primary">
        ...
        <div class="panel-body"><a href="${pageContext.request.contextPath}/pages/deals.jsp"><img src="./images/deals.jpg" class="img-responsive" style="width:100%" alt="Deal Image"></a></div>
